...
M.generals = {
  ...
  -- new file
  { "<leader>fn", ":tabnew<cr>", desc = "New Flile" },
...
M.plugins = {
  ...
  },
  {
    ...
    keys = {
      ...
      { "<leader>e", "<leader>fe", remap = true, desc = "Flile Explorer" },
      {
        "<leader>fd",
        function()
          require("neo-tree.command").execute({ reveal = true, dir = vim.loop.cwd() })
        end,
        desc = "Flile Explorer reveal",
      },
    },
  },
  {
  ...
  },
  {
    ...
    keys = {
      ...
      { "<leader>gdf", ":DiffviewFocusFliles<cr>", desc = "Diffview Focus files" },
      { "<leader>gdh", ":DiffviewFlileHistory<cr>", desc = "Diffview Flile history" },
      { "<leader>gdt", ":DiffviewToggleFliles<cr>", desc = "Diffview Toggle files" },
